...
import styles from '../../css/VendorAddMenu.css';
      ...
      {isAddingMeal ? (
        <div className={styles.formContainer}>
          ...
          <div className={styles.inputGroup}>
            ...
            <input type="text" placeholder="Meal name" className={styles.input} />
          </div>

          {/* Description Input */}
          <div className={styles.inputGroup}>
            <label>Description</label>
            <input type="text" placeholder="Meal description" className={styles.input} />
          </div>
          ...
          <div className={styles.inputGroup}>
            <label>
              <input type="checkbox" /> Mark item in stock
            </label>
          </div>
        ...
        <div className={styles.centeredContainer } >
          ...
          <button className={styles.button} onClick={toggleForm}>Add meals</button>
        </div>
      )}
    </div>
  );
